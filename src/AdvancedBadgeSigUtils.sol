...
contract AdvancedBadgeSigUtils is EIP712("AdvancedBadges", "1") {
    ...
    function getTypedDataHash(Event memory _event) public view returns (bytes32) {
        return keccak256(abi.encodePacked("\x19\x01", _hashTypedDataV4(getStructHash(_event))));
    }
